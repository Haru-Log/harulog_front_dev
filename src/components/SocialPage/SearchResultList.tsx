import { Table, UserRoundX, UserSearch, XCircle } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import SocialProfileImg from './SocialProfileImg';
import { cancelFollow } from '@/api/follow/CancelFollow';
import { deleteFollower } from '@/api/follow/DeleteFollow';
    ...
    switch (searchToggle) {
      ...
      case 'followers':
        return (
          ...
          >
            <UserRoundX color="#ffffff" className="mr-2 h-5 w-5" />
            팔로워 삭제하기
          </Button>
        );
      default:
    ...
    <div className="flex items-center w-full justify-center">
      <div className="w-full mt-7 border rounded-xl px-5 py-5 ">
        {userList.length !== 0 ? (
          ...
          <div className="text-black flex justify-center py-5">
            검색 결과가 없습니다.
          </div>
        )}
      </div>
