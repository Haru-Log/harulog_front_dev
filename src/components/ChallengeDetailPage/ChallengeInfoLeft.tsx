  ...
  const challengeGoal =
    challenge.categoryName === '기상'
      ? `${
        ...
        }시 ${challenge.challengeGoal % 60}분`
      : `${challenge.challengeGoal}분`;
    ...
    <div className="flex flex-col mr-10">
      <div>
        <img
          src={challengeImg}
          alt="챌린지 이미지"
          className="object-cover aspect-square max-w-96 rounded-xl drop-shadow-md"
        />
        <div className="flex flex-row mt-3 items-center">
          <span className="font-bold text-base mr-10 whitespace-nowrap">
            목표
          </span>
        ...
        <div className="flex flex-row mt-3 items-center">
          ...
          <span className="font-bold text-sm whitespace-nowrap">
            {startDateString} - {endDateString} [{challengeTerm}일]
          </span>
        </div>
      </div>
    </div>
