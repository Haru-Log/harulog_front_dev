...
const Heatmap: React.FC<{ data: Jandi[]; categoryMax: any }> = ({
  data,
  categoryMax,
}) => {
  return (
      ...
      <CalendarHeatmap
        ...
        classForValue={(value: any) => {
          if (!value || Object.values(value.category).length === 0) {
            ...
            if (
              Object.values<number>(value.category)[0] >
              (categoryMax[Object.keys(value.category)[0]] / 4) * 3
            ) {
              return `color-${Object.keys(value.category)[0]}-4`;
            } else if (
              Object.values<number>(value.category)[0] >
              categoryMax[Object.keys(value.category)[0]] / 2
            ) {
              return `color-${Object.keys(value.category)[0]}-3`;
            } else if (
              Object.values<number>(value.category)[0] >
              categoryMax[Object.keys(value.category)[0]] / 4
            ) {
          ...
          ${
            Object.keys(value.category).length === 1
              ? `${Object.keys(value.category)[0]} ${
                  Object.keys(value.category)[0] === '기상'
                    ? Math.floor(
                        Object.values<number>(value.category)[0] / 60
                      ) +
                      '시 ' +
                      Math.floor(Object.values<number>(value.category)[0] % 12)
                    : Object.values(value.category)[0]
                }분`
