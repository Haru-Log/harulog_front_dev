  ...
  return (
    <div className="z-50 absolute font-ibm">
      <div className="fixed inset-3 flex justify-center">
        <div
          className="w-[50%] max-w-[800px] h-[90vh] relative shadow-2xl flex rounded-xl overflow-auto bg-[#ececec] scrollbar-hide"
          ref={ref}
        >
          <div className="w-full flex flex-col items-center p-10">
            ...
            <Link
              to={`${process.env.REACT_APP_BACKEND_DEPLOY}/oauth2/authorization/kakao`}
            >
              <img
                src={KakaoIcon}
                alt="kakao icon"
