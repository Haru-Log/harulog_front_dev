  ...
  return (
    <div className='flex flex-col mx-10 mt-10 border-2 rounded-xl px-10 py-10'>
      ...
      <div className='flex justify-between mt-10'>
        ...
        <Button className='bg-point rounded-lgtext-sm w-28 py-2 hover:ring-2 hover:ring-point hover:bg-point-hover active:bg-point-active drop-shadow-md'>저장</Button>
      </div>
    </div>
  )
}
