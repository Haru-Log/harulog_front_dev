...
import { createNewChatRoom } from '@/api/chats/CreateNewChatRoom';
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="w-auto h-auto z-50 bg-white p-8 rounded-3xl drop-shadow-xl">
        ...
        <div className="mt-10 flex justify-between w-full">
          <Button
            className="bg-main font-semibold hover:bg-main-hover shadow-lg"
            onClick={onCancel}
          >
            취소
          </Button>
          <Button
            className="bg-point text-white font-semibold ml-4 hover:bg-point-hover shadow-lg"
            onClick={() => setShowConfirmation(true)}
            disabled={userWillAdded.length === 0}
          >
            생성
          </Button>
        </div>
      ...
      {showConfirmation && (
        <ConfirmationModal
          ...
          onConfirm={() => {
            handleChatCreate(userWillAdded);
